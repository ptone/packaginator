...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Package.metadata_last_fetched'
        db.add_column('package_package', 'metadata_last_fetched', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Package.metadata_fetch_success'
        db.add_column('package_package', 'metadata_fetch_success', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Package.metadata_fetch_message'
        db.add_column('package_package', 'metadata_fetch_message', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Package.metadata_last_fetched'
        db.delete_column('package_package', 'metadata_last_fetched')

        # Deleting field 'Package.metadata_fetch_success'
        db.delete_column('package_package', 'metadata_fetch_success')

        # Deleting field 'Package.metadata_fetch_message'
        db.delete_column('package_package', 'metadata_fetch_message')
    ...
    models = {
        ...
        'package.package': {
            ...
            'metadata_fetch_message': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'metadata_fetch_success': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'metadata_last_fetched': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
